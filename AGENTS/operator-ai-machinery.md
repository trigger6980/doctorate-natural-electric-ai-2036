...
4. **Task Graph Executor** — runs ordered or conditional workflows with checkpointing for intermittent compute.
...
Many of the architectural models in the Genetic / Architectural Model Database are intended to plug into this operator machinery as interchangeable or composable components.

## Status
Foundational document. Concrete orchestration code and configuration schemas will be added incrementally under `AGENTS/` and linked from the model catalog.
