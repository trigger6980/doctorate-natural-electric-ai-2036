...
| **Operator integration** | Wiring an existing host gate (`gate_task`, broker, checkpoint) into the buyer’s own runner | On-device flash mapping or a hardware energy observer |
