...
Paste order for those replies is in [`inquiry-response-template.md`](inquiry-response-template.md). After acceptance, use [`post-quote-packet.md`](post-quote-packet.md).
