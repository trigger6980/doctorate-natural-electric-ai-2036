...
- [x] Model cards 04–14 given the same interface + energy-budget depth as models 01–03.
...
- [ ] Additional model cards (15+) given the same interface + energy-budget depth.
