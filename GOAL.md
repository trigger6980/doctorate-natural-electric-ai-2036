...
- [ ] Inquiry helper `stamp_invariants(inquiry)` plus stamp fields `stamp_invariants_ok` / `stamp_invariants` (host coherence check; not a published dollar amount; blocked on helper-file restore).
