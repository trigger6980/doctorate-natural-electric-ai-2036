...
- Enterprise: see the Order & Contract page to request identical or customized instances under formal agreement. Attach the scope-assumptions table so energy claims stay labeled. Use placeholder engagement tiers to name the *shape* of work — not a price.
